...
private:
    ...
    // Wrapper per le callback MQTT
    static void onMQTTConnectWrapper(struct mosquitto*, void*, int);
    static void onMQTTMessageWrapper(struct mosquitto*, void*, const struct mosquitto_message*);
    static void onMQTTDisconnectWrapper(struct mosquitto*, void*, int);
