...
// MQTT Configuration
#define VISION_MQTT_BROKER_HOST     "localhost"
#define VISION_MQTT_BROKER_PORT     1883
#define VISION_MQTT_BASE_TOPIC      "smartmower/vision/"
#define VISION_MQTT_KEEPALIVE       60

// Legacy compatibility defines
#define VISION_MQTT_BROKER          VISION_MQTT_BROKER_HOST
#define VISION_MQTT_PORT            VISION_MQTT_BROKER_PORT
#define VISION_MQTT_USERNAME        "mower"
#define VISION_MQTT_PASSWORD        "smart"
#define VISION_MQTT_CLIENT_ID       "smartmower_vision_camera"
...
// MQTT Topics - Camera (relative to VISION_MQTT_BASE_TOPIC)
#define VISION_TOPIC_CAMERA         "camera"
#define VISION_TOPIC_CAMERA_STATUS  "camera/status"
#define VISION_TOPIC_CAMERA_CONFIG  "camera/config"

// MQTT Topics - Grass Detection (relative to VISION_MQTT_BASE_TOPIC)
#define VISION_TOPIC_GRASS          "grass"
#define VISION_TOPIC_GRASS_STATUS   "grass/status"
#define VISION_TOPIC_GRASS_CONFIG   "grass/config"

// MQTT Topics - Obstacle Detection (relative to VISION_MQTT_BASE_TOPIC)
#define VISION_TOPIC_OBSTACLE       "obstacle"
#define VISION_TOPIC_OBSTACLE_STATUS "obstacle/status"
#define VISION_TOPIC_OBSTACLE_CONFIG "obstacle/config"

// MQTT Topics - Perimeter Detection (relative to VISION_MQTT_BASE_TOPIC)
#define VISION_TOPIC_PERIMETER      "perimeter"
#define VISION_TOPIC_PERIMETER_STATUS "perimeter/status"
#define VISION_TOPIC_PERIMETER_CONFIG "perimeter/config"
