...
public:
    ...
    bool loadFromFile(const string& filename) override {
        ...
        if (!file.is_open()) {
            cerr << "Impossibile aprire il file di configurazione: " << filename << endl;
            return false;
        }
    ...
    bool saveToFile(const string& filename) const override {
        ...
        if (!file.is_open()) {
            cerr << "Impossibile salvare il file di configurazione: " << filename << endl;
            return false;
        }
    ...
    void setString(const string& key, const string& value) override {
        // Implementazione per l'impostazione di un valore stringa
        config_[key] = value;
    }
